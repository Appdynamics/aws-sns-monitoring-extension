...
| | displayAccountName | Display name used in metric path | "MyAWSSNS" |
| | regions | Regions where SNS is registered | **Allowed values:**<br/>"ap-southeast-1",<br/>"ap-southeast-2",<br/>"ap-northeast-1",<br/>"eu-central-1",<br/>"eu-west-1",<br/>"us-east-1",<br/>"us-west-1",<br/>"us-west-2",<br/>"sa-east-1" |
...
| | ----- | ----- | ----- |
| | metricPrefix | The path prefix for viewing metrics in the metric browser. | "Custom Metrics\|Amazon SNS\|" |
...
metricPrefix: "Custom Metrics|Amazon SNS|"
~~~
...
## Metrics
Typical metric path: **Application Infrastructure Performance|\<Tier\>|Custom Metrics|Amazon SNS|\<Account Name\>|\<Region\>|Topic Name|\<Topic Name\>** followed by the metrics defined in the link below:

- [SNS Metrics](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/sns-metricscollected.html)

## Contributing

Always feel free to fork and contribute any changes directly via [GitHub](https://github.com/Appdynamics/aws-sns-monitoring-extension).

## Community

Find out more in the [AppSphere](https://www.appdynamics.com/community/exchange/extension/aws-sns-monitoring-extension) community.
